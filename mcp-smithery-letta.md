...
2. Open the Memory MCP page on <a href="https://smithery.ai/server/%40letta-ai/memory-mcp?utm_source=chatgpt.com" target="_blank">Smithery</a> (`@letta-ai/memory-mcp`) and configure it with your Letta API key and a `user_id` (or accept the default).
