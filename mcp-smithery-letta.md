...
3. From that Smithery page, click "Get URL with keys instead" (the orange link below "Get Connection URL") and copy the MCP server URL it provides (including any query parameters).
